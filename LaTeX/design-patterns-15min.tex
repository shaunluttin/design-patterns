...
\begin{frame}{Encapsulate what varies.}
    \begin{itemize}
        ...
        \item \ldots what varies.
            \begin{itemize}
                \item This refers to changes in the source code.
...
\begin{frame}{A class should have only one reason to change.}
    ...
    \item Why? 
        \begin{itemize}
            \item Reuse: Allow a client to use feature X without bringing feature A-Z. 
            \item Change: Allow a developer to change feature X without breaking feature A-Z.
        \end{itemize}
    \end{itemize}
\end{frame}
