...
\begin{frame}{Don't call us, we'll call you.}
    \begin{itemize}
        \item This principle is also known as
            ...
            \end{itemize}
        \item Inversion of Control (IoC) is about \emph{when} things happen.
        \item It differs from Dependency Inversion,
            \begin{itemize}
                \item which is about who \emph{owns} an abstraction.
            \end{itemize}
        \item IoC (Inversion of Control) "makes a framework different from a library" (Fowler)
            \begin{itemize}
